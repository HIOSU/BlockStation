...
void mouseReleased()
{
  ...
  } else if ((mx > 50 && my > 70) && (mx < 250 & my < 420) && Screencount.equals("select") && helpcount == 0) // Gameselection
  {
    background(#CBCBCB);
    Screencount = "stage";
  } else if ((mx > 150 && my > 200) && (mx < 250 & my < 300) && Screencount.equals("stage") && stage.stagecount1 == true)// Chapter
  {
    surface.setSize(1200, 700);
    background(#CBCBCB);
    Screencount = "stage1";
  } else if ((mx > 300 && my > 200) && (mx < 400 & my < 300) && Screencount.equals("stage") && stage.stagecount2 == true)// Chapter
  {
    surface.setSize(1200, 700);
    background(#CBCBCB);
    Screencount = "stage2";
  } else if ((mx > 450 && my > 200) && (mx < 500 & my < 300) && Screencount.equals("stage") && stage.stagecount3 == true)// Chapter
  {
    surface.setSize(1200, 700);
    background(#CBCBCB);
    Screencount = "stage3";
  } else if ((mx > 550 && my > 200) && (mx < 650 & my < 300) && Screencount.equals("stage") && stage.stagecount4 == true)// Chapter
  {
    surface.setSize(1200, 700);
    background(#CBCBCB);
    Screencount = "stage4";
  } else if ((mx > 700 && my > 200) && (mx < 800 & my < 300) && Screencount.equals("stage") && stage.stagecount5 == true)// Chapter
  {
    surface.setSize(1200, 700);
    background(#CBCBCB);
    Screencount = "stage5";
  ...
  if ( stage.p < 2 && Screencount.equals("stage1"))
  {
    BlockR(stage.mobc1, stage.mobc1s);
  } else if ( stage.p < 2 && Screencount.equals("stage2"))
  {
    BlockR(stage.mobc2, stage.mobc2s);
  } else if ( stage.p < 2 && Screencount.equals("stage3"))
  {
...
void mousePressed()
{
  ...
  if (stage.p < 2 && mouseButton == LEFT && (Screencount.equals("stage1")))
  {
    //noCursor();
  ...
  } else if ( stage.p < 2 && mouseButton == LEFT && (Screencount.equals("stage2")))
  {
    //if ( p < 2 )
    //{
    BlockP(stage.mobc2, stage.mobc2s);
  } else if (  stage.p < 2 && mouseButton == LEFT && (Screencount.equals("stage3")))
  {
    //if ( p < 2 )
    //{
...
void mouseDragged()
{
  ...
  {
    BlockD(stage.mobc3);
  } else if (stage.p < 3 && Screencount.equals("stage4"))
  {
    BlockD(stage.mobc4);
  } else if (stage.p < 3 && Screencount.equals("stage5"))
  {
    BlockD(stage.mobc5);
  }
  //for (int i= 0; i < stage.getMobc1()[p].length; i++)
...
{
  for (int i= 0; i < blocks[stage.p].length; i++)
  {
    if (blocks[stage.p][i].getIsCilcked() == true)
    {
      float [] mxy = {(float)mouseX-12.5, (float)mouseY-12.5};          
      blocks[stage.p][i].setLocation(mxy);
      //print(stage.getMobc1()[p][i].getLocation()[0] + "," +  stage.getMobc1()[p][i].getLocation()[1]);
      // stage.draw_array(stage.getMobc1()[p][i].getArray(),stage.getMobc1()[p][i].getLocation()[0], stage.getMobc1()[p][i].getLocation()[1], true, stage.getMobc1()[p][i].getIndex());
    }
  }
...
{
  for (int i= 0; i < block[stage.p].length; i++)
  {
    if (blocks[stage.p][i/3][i%3] == 1)
    {
      //if ((mouseX  > 155*(i%3) && mouseY > 110+(155*((int)(i/3))) && (mouseX < 150+ (155*(i%3)) && mouseY < 260+ (155*((int)(i/3))))))
      if ((mouseX  > block[stage.p][i].getLocation()[0] && mouseY > block[stage.p][i].getLocation()[1] && (mouseX < 150+ block[stage.p][i].getLocation()[0]) && mouseY < 135+ block[stage.p][i].getLocation()[1]))
      {
...
void BlockR(Block [][] block, int [][][] blocks)
{
  for (int i= 0; i < block[stage.p].length; i++)
  {
    if (block[stage.p][i].getIsCilcked() == true)
    {
      if ((((700 - (block[stage.p][i].getBlockArea()[0]*30)) <= mouseX) && ((1145 - (block[stage.p][i].getBlockArea()[2]*30)) >= mouseX) && ((250 - (block[stage.p][i].getBlockArea()[1]*30)) <= mouseY ) && ((395 - ((block[stage.p][i].getBlockArea()[3]*30))) >= mouseY)) && (Screencount.equals("stage1"))) {
        int[][] newArray = test(block[stage.p][i], stage.moba1, 700, 250);
        if (stage.flag == 0) {
          for (int q = 0; q < stage.moba1.length; q++) {
            for (int w = 0; w< stage.moba1[q].length; w++) {
              stage.moba1[q][w] = newArray[q+block[stage.p][i].getBlockArea()[1]][w+block[stage.p][i].getBlockArea()[0]];
            }
          }
          ...
          block[stage.p][i].setLocation(stage.xy);
          blocks[stage.p][i/3][i%3] = 1;
          CheckM = false;
        }
      } else if ((((650 - (block[stage.p][i].getBlockArea()[0]*30)) <= mouseX) && ((945 - (block[stage.p][i].getBlockArea()[2]*30)) >= mouseX) && ((150 - (block[stage.p][i].getBlockArea()[1]*30)) <= mouseY ) && ((445 - ((block[stage.p][i].getBlockArea()[3]*30))) >= mouseY)) && (Screencount.equals("stage2"))) {
        int[][] newArray = test(block[stage.p][i], stage.moba2, 650, 150);
        if (stage.flag == 0) {
          for (int q = 0; q < stage.moba2.length; q++) {
            for (int w = 0; w< stage.moba2[q].length; w++) {
              stage.moba2[q][w] = newArray[q+block[stage.p][i].getBlockArea()[1]][w+block[stage.p][i].getBlockArea()[0]];
            }
          }
      ...
      } else if ((((700 - (block[stage.p][i].getBlockArea()[0]*30)) <= mouseX) && ((1055 - (block[stage.p][i].getBlockArea()[2]*30)) >= mouseX) && ((150 - (block[stage.p][i].getBlockArea()[1]*30)) <= mouseY ) && ((505 - ((block[stage.p][i].getBlockArea()[3]*30))) >= mouseY)) && (Screencount.equals("stage3"))) {
        int[][] newArray = test(block[stage.p][i], stage.moba3, 700, 150);
        if (stage.flag == 0) {
          for (int q = 0; q < stage.moba3.length; q++) {
            for (int w = 0; w< stage.moba3[q].length; w++) {
              stage.moba3[q][w] = newArray[q+block[stage.p][i].getBlockArea()[1]][w+block[stage.p][i].getBlockArea()[0]];
            }
          }
      ...
      } else if ((((700 - (block[stage.p][i].getBlockArea()[0]*30)) <= mouseX) && ((1055 - (block[stage.p][i].getBlockArea()[2]*30)) >= mouseX) && ((150 - (block[stage.p][i].getBlockArea()[1]*30)) <= mouseY ) && ((445 - ((block[stage.p][i].getBlockArea()[3]*30))) >= mouseY)) && (Screencount.equals("stage4"))) {
        int[][] newArray = test(block[stage.p][i], stage.moba4, 700, 150);
        if (stage.flag == 0) {
          for (int q = 0; q < stage.moba4.length; q++) {
            for (int w = 0; w< stage.moba4[q].length; w++) {
              stage.moba4[q][w] = newArray[q+block[stage.p][i].getBlockArea()[1]][w+block[stage.p][i].getBlockArea()[0]];
            }
          }
      ...
      } else if ((((800 - (block[stage.p][i].getBlockArea()[0]*30)) <= mouseX) && ((1095 - (block[stage.p][i].getBlockArea()[2]*30)) >= mouseX) && ((150 - (block[stage.p][i].getBlockArea()[1]*30)) <= mouseY ) && ((445 - ((block[stage.p][i].getBlockArea()[3]*30))) >= mouseY)) && (Screencount.equals("stage5"))) {
        int[][] newArray = test(block[stage.p][i], stage.moba5, 800, 150);
        if (stage.flag == 0) {
          for (int q = 0; q < stage.moba5.length; q++) {
            for (int w = 0; w< stage.moba5[q].length; w++) {
              stage.moba5[q][w] = newArray[q+block[stage.p][i].getBlockArea()[1]][w+block[stage.p][i].getBlockArea()[0]];
            }
          }
      ...
      block[stage.p][i].setIsCilcked(false);
    }
  }
}
